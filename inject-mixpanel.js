...
const injectMixpanel = (function() {
  const mixpanelInjector = {
    ...
    initMixpanel: function() {
      console.log('Injecting mixpanel from extension...');
      ...
      // ------ mixpanel snippet ----------
      /* eslint-disable */
      const MIXPANEL_CUSTOM_LIB_URL = 'https://mixpanel.com/libs/mixpanel.dev.js';
      ...
      window.mixpanel.init('225a6b8c2bc4f08e7cd97ac3fa4e1404', {autotrack: true});
...
if (!(window.location.hostname === 'mixpanel.com' || window.location.hostname.endsWith('mixpanel.org'))) {
  ...
  script.innerHTML = 'var __injectMixpanel = ' + injectMixpanel.toString() + '; __injectMixpanel();';
